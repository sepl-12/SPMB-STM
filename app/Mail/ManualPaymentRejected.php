...
class ManualPaymentRejected extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Pembayaran Manual Ditolak - ' . config('app.name'),
        );
    }
    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: [
                ...
                'rejectionReason' => $this->manualPayment->rejection_reason,
                'rejectionDate' => $this->manualPayment->approved_at?->format('d F Y, H:i'),
                'rejectedBy' => $this->manualPayment->approvedBy?->name ?? 'Admin',
            ],
        );
    }
