    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative">
            ...
            @php
                ...
                // Default icons untuk auto-assign
                $defaultIcons = ['user-plus', 'document', 'check-circle', 'currency'];
            @endphp
            ...
            <div class="relative flex items-start mb-12 last:mb-0">
                ...
                <div class="ml-6 flex-1 bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                    <h3 class="text-xl font-bold text-gray-900 mb-2">{{ $stepNumber }}. {{ $item['title'] }}</h3>
